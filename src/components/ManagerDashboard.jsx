    ...
    <div className="container" style={{ padding: '2rem 0' }}>
      ...
      <div style={{
        ...
        <div className="card glass-card" style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', padding: '1.5rem' }}>
          <div style={{ background: 'var(--accent-soft)', color: 'var(--accent)', padding: '0.75rem', borderRadius: 'var(--radius-sm)' }}>
            <TrendingUp size={24} />
          </div>
          <div>
        ...
        {/* Stat 2: Active Tasks */}
        <div className="card glass-card" style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', padding: '1.5rem' }}>
          <div style={{ background: 'rgba(234, 179, 8, 0.1)', color: '#eab308', padding: '0.75rem', borderRadius: 'var(--radius-sm)' }}>
            <BarChart2 size={24} />
          </div>
          <div>
        ...
        <div className="card glass-card" style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', padding: '1.5rem' }}>
          <div style={{ background: 'rgba(16, 185, 129, 0.1)', color: '#10b981', padding: '0.75rem', borderRadius: 'var(--radius-sm)' }}>
            <CheckCircle size={24} />
          </div>
          <div>
        ...
        <div className="card glass-card" style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', padding: '1.5rem' }}>
          <div style={{ background: 'rgba(245, 158, 11, 0.1)', color: '#f59e0b', padding: '0.75rem', borderRadius: 'var(--radius-sm)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            {tasks.map((task) => (
              <div key={task.id} className="task-item-container" style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem' }}>
                  <div>
                    ...
                    <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                      {t('companyName')}: <strong>{task.company}</strong> | {t('budget').split(' ')[0]}: <span style={{ color: 'var(--accent)', fontWeight: 700 }}>₾{task.budget}</span>
                    </span>
                  </div>
                ...
                {task.photo && (
                  <div style={{ marginBottom: '1.25rem', maxWidth: '300px', border: '1px solid var(--border-glass-strong)', borderRadius: 'var(--radius-sm)', overflow: 'hidden' }}>
                    <img 
                      src={task.photo} 
                      alt={task.title} 
                ...
                {/* Task Operations */}
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid var(--border-glass)', paddingTop: '1rem', marginTop: '0.5rem' }}>
                ...
                <div key={exec.id} style={{
                  ...
                  <img 
                    ...
                    style={{
                      ...
                      borderRadius: '0',
                      objectFit: 'cover',
                      border: exec.isBlocked ? '2px solid #ef4444' : '1px solid var(--border-glass)'
                    }}
                  />
                  <div style={{ flex: 1 }}>
      ...
      {editingTask && (
        <div style={{
          ...
          <div className="glass-card animate-fade-in" style={{
            ...
            <h3 style={{ fontSize: '1.45rem', fontWeight: 900, marginBottom: '1.5rem', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <Edit2 size={20} color="var(--accent)" />
            ...
            <form onSubmit={handleEditSubmit}>
              ...
              <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '0.5rem' }}>
                  ...
                  {editPhoto && (
                    <div style={{ position: 'relative', width: '50px', height: '50px', border: '1px solid var(--border-glass-strong)', borderRadius: 'var(--radius-sm)', overflow: 'hidden' }}>
                      <img 
                        src={editPhoto} 
                        alt="Preview" 
      ...
      {inspectedExecutor && (
        <div style={{
          ...
          <div className="glass-card animate-fade-in" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', marginBottom: '1.5rem', borderBottom: '1px solid var(--border-glass)', paddingBottom: '1.25rem' }}>
              <img 
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.8rem' }}>
                  ...
                  <span style={{ color: 'var(--accent)', fontWeight: 800 }}>| ₾{inspectedExecutor.balance}</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.35rem' }}>
                {inspectedExecutor.skills.map((skill, i) => (
                  <span key={i} style={{ background: 'rgba(0,0,0,0.04)', border: '1px solid var(--border-glass)', padding: '0.2rem 0.5rem', fontSize: '0.75rem', fontWeight: 600, color: 'var(--text-sub)', borderRadius: 'var(--radius-sm)' }}>
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div>
              <h4 style={{ fontSize: '0.9rem', fontWeight: 800, marginBottom: '0.75rem', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                ...
                <span style={{ fontSize: '0.75rem', background: 'var(--accent)', color: 'var(--text-on-accent)', padding: '0.1rem 0.4rem' }}>
              ...
              {(!inspectedExecutor.reviews || inspectedExecutor.reviews.length === 0) ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', maxHeight: '200px', overflowY: 'auto', paddingRight: '0.25rem' }}>
                  {inspectedExecutor.reviews.map((rev, i) => (
                    <div key={i} style={{ border: '1px solid var(--border-glass)', borderRadius: 'var(--radius-sm)', padding: '0.85rem', background: 'rgba(0,0,0,0.02)' }}>
                      ...
                      <p style={{ margin: 0, fontStyle: 'italic', fontSize: '0.8rem', color: 'var(--text-sub)' }}>
                        "{rev.comment}"
                      </p>
